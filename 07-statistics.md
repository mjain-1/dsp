...
>> I = Identical; F = Fraternal; X = Twin boys   
````
Prior probabilities: p(I) = 1/300; p(F) = 1/125    
P(X|I and Elvis is a boy) = 1    
P(X|F and Elvis is a boy) = 1/2    
P(I|X) = (1/300)*1/(1/300*1 + 1/125*1/2) = 5/11
````
---
